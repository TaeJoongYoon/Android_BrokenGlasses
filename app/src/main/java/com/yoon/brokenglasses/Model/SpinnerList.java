...
public class SpinnerList {
    ...
    public static List<String> jobs = new ArrayList<String>(Arrays.asList("고등학생","대학생","회사원","자영업자","IT","금융업계","화학","선생님"));
    public static List<String> regions = new ArrayList<>(Arrays.asList("시/도 선택","서울특별시","인천광역시","대전광역시","광주광역시","대구광역시","울산광역시","부산광역시","경기도","강원도","충청북도","충청남도","전라북도","전라남도","경상북도","경상남도","제주도"));
    public static String[][] subRegions = {
    ...
    public static List<String> birth = new ArrayList<>(Arrays.asList(
            "1980","1981","1982","1983","1984","1985","1986","1987","1988","1989",
            "1990","1991","1992","1993","1994","1995","1996","1997","1998","1999",
            "2000","2001","2002","2003","2004","2005","2006","2007","2008","2009",
            "2010","2011","2012","2013","2014","2015","2016","2018","2019"
    ));
    public static List<String> formation = new ArrayList<>(Arrays.asList(
            "선택","4-4-2","4-3-3","4-2-1-2","3-4-1-2","3-2-3-2"
    ));
}
