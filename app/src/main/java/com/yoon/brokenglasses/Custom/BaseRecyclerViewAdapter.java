package com.yoon.brokenglasses.Custom;
...
import com.yoon.brokenglasses.Search.SearchContract;
...
public abstract class BaseRecyclerViewAdapter<T, H extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BaseRecyclerViewAdapter(Context context, SearchContract.View view){
        this.context = context;
    }
