...
public class TeamCheckResponse {
    ...
    public TeamCheckResponse(boolean error, boolean request, String teamUID, String teamName, String teamBirth, String captainUID, List<String> formation, List<Region> region) {
        this.error = error;
